...
export const Header: React.FC = () => {
  ...
  return (
    <header
      ...
      <div className="absolute h-full w-full max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="mr-5">
          <div className="fixed right-5 z-20">
            <div
              ...
              } w-6 h-6 cursor-pointer lg:hidden z-30`}
              onClick={() => {
              ...
              <div
                className={`${
                  isMenuOpen
                    ...
                    : "bg-green-800"
                } h-0.5 rounded-full transition duration-700 ease-out`}></div>
